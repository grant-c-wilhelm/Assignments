    ...
    return (
        <div>
            ...
            <div className="registry-container">
                ...
                <img className="centered-registry-icon amazon" onClick={launchAmazonRegistry} src="https://lh3.googleusercontent.com/proxy/q8b3uziS0Fs_-wdKhffM9TgkvTJZgZa5lx0j6s5mRHLLA_QFsrLPnYa0WcbZk8bH3aPXAGf0WGEMX6r_Lo8Pg2hqvjhKvf4iUSFwzEILF5-3nvJOEpDuGBOAptpWUfCnnxXP5Nn99Mv3KcMkRDgEfr8aYN-sNOk" alt="" />
            </div>
        </div>
